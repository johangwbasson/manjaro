...
sudo pacman -S plank intel-ucode code rofi zsh zsh-syntax-highlighting neovim neovim-qt exa nvm vlc flameshot meld ttf-fira-code jdk8-openjdk openjdk8-doc openjdk8-src java8-openjfx maven gradle bleachbit docker docker-compose emacs libreoffice-still clojure ripgrep leiningen aspell-en libmythes mythes-en languagetool yay termite --noconfirm
